...
function SwirlyDoodle({ className }: Class) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 281 40"
...
function CheckIcon({ className }: Class) {
  return (
    <svg
      aria-hidden="true"
      className={clsx(
        ...
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Simple no bullsh*t pricing,</span>
            </span>{' '}
            for everyone.
          </h2>
        </div>
          ...
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-2xl font-bold tracking-tight text-gray-100">Monthly membership</h3>
            <p className="mt-6 text-base leading-7 text-gray-400">
							It's simple we make money off monthly membership's. No shady user data activities, like some other search engines...
            </p>
            ...
            >
              {includedFeatures.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <CheckIcon className="h-6 w-6 flex-none text-blue-400" aria-hidden="true" />
                  {feature}
                </li>
              ))}
            </ul>
